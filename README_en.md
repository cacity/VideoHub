...
These short demos were generated by real VideoHub workflows and clipped from completed outputs to approximately 11–17 seconds. **Click a preview image to play the video** and inspect beat-synced editing, film commentary, TTS narration, subtitles, and repeatable episode production.

<table>
  <tr>
    <td align="center" width="33%">
      <a href="https://cacity.github.io/VideoHub/showcase/?video=beat-edit-japan.mp4"><img src="./docs/assets/showcase/beat-edit-japan.jpg" width="300" alt="Japan scenic beat edit sample"></a><br>
      <strong>Japan Scenic Beat Edit</strong><br>
      Beat edit · 17 seconds
    </td>
    <td align="center" width="33%">
      <a href="https://cacity.github.io/VideoHub/showcase/?video=wife-elementary-school.mp4"><img src="./docs/assets/showcase/wife-elementary-school.jpg" width="300" alt="Wife Becomes an Elementary School Student commentary sample"></a><br>
      <strong>Wife Becomes an Elementary School Student</strong><br>
      Film commentary · 12 seconds
    </td>
    <td align="center" width="33%">
      <a href="https://cacity.github.io/VideoHub/showcase/?video=banshaku-no-ryugi.mp4"><img src="./docs/assets/showcase/banshaku-no-ryugi.jpg" width="300" alt="Banshaku no Ryugi episode commentary sample"></a><br>
      <strong>Banshaku no Ryugi</strong><br>
      Episode commentary · 15 seconds
    </td>
  </tr>
  <tr>
    <td align="center" width="33%">
      <a href="https://cacity.github.io/VideoHub/showcase/?video=day-of-the-jackal.mp4"><img src="./docs/assets/showcase/day-of-the-jackal.jpg" width="300" alt="The Day of the Jackal commentary sample"></a><br>
      <strong>The Day of the Jackal</strong><br>
      Foreign-language drama · 12 seconds
    </td>
    <td align="center" width="33%">
      <a href="https://cacity.github.io/VideoHub/showcase/?video=kim-agent.mp4"><img src="./docs/assets/showcase/kim-agent.jpg" width="300" alt="Kim Agent action drama commentary sample"></a><br>
      <strong>Kim Agent: True Colors Return</strong><br>
      Action commentary · 11 seconds
    </td>
    <td width="33%"></td>
  </tr>
</table>

> These demos only illustrate VideoHub output quality and do not imply ownership of the underlying films, music, or footage. Rights remain with their respective owners. Only process and publish media you are authorized to use.
